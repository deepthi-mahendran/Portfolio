...
const DATA = {
  ...
  skillProjectMap: {
    'Next.js': ['web-portfolio', 'sara', 'elegant-notes'],
    'React': ['web-portfolio', 'elegant-notes'],
    'TypeScript': ['web-portfolio', 'elegant-notes'],
    'Prisma': ['web-portfolio'],
  ...
  projects: [
    ...
    { id: 'day-06', title: 'Java — Car Rental Agency System', description: 'Add cars/motorcycles/trucks, type-specific attributes (doors, wheels, cargo), robust input validation.', category: 'learning', tags: ['Java', 'Interfaces', 'Polymorphism', 'OOP'], image: '/images/Project06.webp', link: 'https://github.com/deepthi-mahendran/My-Learning-Journal/tree/main/Day-06', github: 'https://github.com/deepthi-mahendran/My-Learning-Journal/tree/main/Day-06', detail: 'Built a polymorphic Java vehicle rental engine leveraging interfaces and class inheritance to manage diverse vehicle types (cars, motorcycles, trucks) with custom attributes and inventory reporting.' },
    ...
    { id: 'day-14', title: 'Python — Secure Password Generator', description: 'Cryptographically secure passwords (secrets module), length slider (8–50), clipboard copy, dark GUI.', category: 'learning', tags: ['Python', 'CustomTkinter', 'Security', 'GUI'], image: '/images/Project14.webp', link: 'https://github.com/deepthi-mahendran/My-Learning-Journal/tree/main/Day-14', github: 'https://github.com/deepthi-mahendran/My-Learning-Journal/tree/main/Day-14', detail: 'Built a security utility in Python using the `secrets` module for cryptographically strong random generation with length sliders (8-50), character set selection, and 1-click clipboard copying.' },
